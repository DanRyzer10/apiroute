package com.danam.iroute.apiroute.repositories;

import com.danam.iroute.apiroute.db.config.ConnectionManager;
...
public class IRouteRepository {
    ...
    public String saveFile(MultipartFile file) {
        try(BufferedReader reader = new BufferedReader(new InputStreamReader(file.getInputStream()))){
            ...
            extractDataFromCSV(csvReader, statement);
    ...
    public int extractAllRegisterByValidation(String processDate){
        try{
            Connection conn = ConnectionManager.createConnection();
    ...
    private static void  extractDataFromCSV(CSVReader csvReader, CallableStatement statement) throws IOException, CsvValidationException, SQLException {
        String[] csvValues;
